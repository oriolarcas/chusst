...
impl PlayerBitboards {
    ...
    pub fn in_between(source: &Position, target: &Position) -> Bitboard {
        ...
        IN_BETWEEN_TABLE[source_index][target_index]
    }
...
const IN_BETWEEN_TABLE: [[Bitboard; 64]; 64] = [
    [
        0,
        0,
        0x0000000000000002,
    ...
    fn check_in_between_table() {
        ...
        for source in 0..64 {
            for target in 0..64 {
                ...
                let same_rank = rank_distance == 0 && file_distance > 0;
                let same_file = file_distance == 0 && rank_distance > 0;
                let same_diagonal = rank_distance == file_distance;
